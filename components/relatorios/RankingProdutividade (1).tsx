        ...
        {ranked.map((r, i) => {
          ...
          return (
            <div key={r.nome} className="flex items-center gap-3">
              <span className="w-5 text-sm text-center select-none">
                {i < 3 ? MEDALS[i] : ''}
              </span>
              <span className="w-20 text-xs text-gray-400 text-right truncate shrink-0">
                {r.nome}
              </span>
              ...
              <span
                className="w-24 text-xs font-semibold text-right shrink-0"
